    ...
    <header id="headersec">
        <div id="header-div" class="header-div">
            ...
            <ul class="right-header">
                ...
                <li>
                    <a href="https://www.instagram.com/motongen_and_gearbox/"><i
                            class="fab fa-instagram text-danger"></i></a>
                </li>
                <li>

                    <a href="{{route($englishRouteName)}}" title="switch to english"><img src="assets/england-flag.webp"
                                                                                          alt="english"
                                                                                          title="switch to english"
                                                                                          width="20"> </a>| <a
                        href="{{route($frenchRouteName)}}" title="passer au français"><img src="assets/france.webp"
                                                                                           alt="french" width="20"
                                                                                           title="passer au français"></a>
...
@include('layouts.nav')
    ...
    <div class="first-section-body">
        <div id="first-section-body-inner" class="first-section-body-inner">
            ...
            <p>
                MotoNgen is an engine, gearbox and axles remanufacturing company. We procure engines for our customers
                across the nation and West Africa coast.
            </p>
            ...
            <div id="input-div" class="input-div">
                <input type="search"  id="search-input"  onkeyup="searchContent()" placeholder="Search for your part here (E.g Brake pad, Toyota Corolla 2010)"/>
        ...
        <div id="carouselExampleIndicators" class="carousel slide carouselimg" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/assets/motongen_website_banner_small2.jpg" class="d-block w-100 " alt="..." width="500"
                         height="600">
                </div>
                <div class="carousel-item">
                    <img src="/assets/motongen_web_banner2.jpg" class="d-block w-100" alt="..." width="500"
                         height="600">
                </div>
                <div class="carousel-item">
                    <img src="/assets/motongen_website_banner_small.jpg" class="d-block w-100" alt="..." width="500"
                         height="600">
                </div>
            </div>
...
<script defer src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.1/dist/umd/popper.min.js"
        integrity="sha384-SR1sx49pcuLnqZUnnPwx6FCym0wLsk5JZuNx2bPPENzswTNFaQU1RDvt3wT4gWFG"
        crossorigin="anonymous"></script>
<script defer src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.min.js"
